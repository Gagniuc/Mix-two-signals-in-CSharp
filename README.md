...
What can you expect from the code above? The effect of the above source code for longer signals can be seen in a graphical form below: 

https://gagniuc.github.io/Waveform-mixing-with-Spectral-Forecast-in-JS/
